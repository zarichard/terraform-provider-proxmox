...
import (
	...
	clusterfirewall "github.com/zarichard/terraform-provider-proxmox/proxmoxtf/resource/cluster/firewall"
	"github.com/zarichard/terraform-provider-proxmox/proxmoxtf/resource/firewall"
)
...
func createResourceMap() map[string]*schema.Resource {
	return map[string]*schema.Resource{
		...
		"proxmox_virtual_environment_persistent_disk":                 resource.PersistentDisk(),
	}
}
